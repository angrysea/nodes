...
public class XMLAgentException extends AMGException {
	...
	public XMLAgentException(final int sev, final int code) {
		super(sev, FACILITY_SERVER, code);
	}

	public XMLAgentException(final int sev, final int code, final String xT) {
		super(sev, FACILITY_SERVER, code);
		setExtraText(xT);
	}
