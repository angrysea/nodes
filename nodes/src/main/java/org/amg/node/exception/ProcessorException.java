...
public class ProcessorException extends AMGException {
	...
	public ProcessorException(final int sev, final int code) {
		super(sev, FACILITY_SERVER, code);
	}

	public ProcessorException(final int sev, final int code, final String xT) {
		super(sev, FACILITY_SERVER, code);
		setExtraText(xT);
	}
