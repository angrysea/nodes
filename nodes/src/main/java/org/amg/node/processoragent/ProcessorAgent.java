...
public final class ProcessorAgent implements Runnable {
	...
	public Object process() throws AMGException {
	...
	public Object process(Envelope envelope) throws AMGException {
	...
	public Object execute(String methodName, Object arg) throws AMGException {
	...
	public void preProcess(String className) throws AMGException {
