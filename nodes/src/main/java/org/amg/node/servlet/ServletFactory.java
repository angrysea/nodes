...
import org.amg.node.servlet.http.HttpSession;
...
public class ServletFactory implements Runnable {
	 ...
	 * 1; servletContext.setAttribute("com.amg.xsltpath",
	 * server.getXSLPath());
	 * 
	 ...
	 * ServletException(AMGException.SEVERITY_WARNING,
	 ...
	 * servletex = new ServletException(AMGException.SEVERITY_WARNING,
	 ...
	 * 
	 * if (broker == null) { AMGException servletex = new
	 * AMGException(AMGException.SEVERITY_FATAL,
	 ...
	 * (Exception e) { AMGException servletex = new
	 * AMGException(AMGException.SEVERITY_FATAL,
