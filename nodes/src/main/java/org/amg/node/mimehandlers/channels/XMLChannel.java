...
import org.amg.node.mimehandlers.controllers.Controller;
import org.amg.node.mimehandlers.servlets.ServicesConfig;
...
//						false);
			...
			try {
				(resp).addHeader("amg-Error-Message: ", result);
				(resp).sendError(601);
			} catch (Exception ioe) {
//				logger.debug("amg-Error-Message: " + result);
			}
		}
	}
...
//			logger.error(
//					"XMLSVC: Sending HTTP 601 amg-Error-Message response : "
