...
public interface HTTP {
	...
	public static final byte byteArrayVersion[] = { (byte) 'H', (byte) 'T', (byte) 'T', (byte) 'P', (byte) '/',
			(byte) '1', (byte) '.', (byte) '0', (byte) ' ' };
	public static final String server = "Server: AMG/1.0";
	...
	public static final String contentTypeHTML = "Content-Type: text/html; charset=UTF-8";
	...
	public static final String contentTypeCSS = "Content-Type: text/css";
	...
	public static final String msg200[] = { " OK", " Created", " Accepted", " Non-Authoritative information",
			" No Content", " Reset Content", " Partial Content" };
	public static final String msg300[] = { " Multiple Choices", " Moved Permanently", " Found", " See Other",
			" Not Modified", " Use Proxy", "", " Temporary Redirect" };
	public static final String msg400[] = { " Bad Request", " Unauthorized", " Payment Required", " Forbidden",
	...
	public static final String msg500[] = { " Internal Server Error", " Not Implemented", " Bad Gateway",
