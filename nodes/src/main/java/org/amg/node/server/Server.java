...
import org.amg.node.logging.logserver.LogServer;
import org.amg.node.mimehandlers.MimePop_Processor;
...
public class Server extends IServer {
	...
	@Override
	public void initialize(String[] args) throws AMGException {
	...
	@Override
	public void initialize(String configFile) throws AMGException {
	...
	@Override
	public void initialize(Properties properties) throws AMGException {
	...
	public void loadSettings(String[] args) throws AMGException {
	...
	@Override
	public void start() throws AMGException {
	...
	protected void initializeSocketServer() throws AMGException {
		...
		try {
			...
			final AMGException serverex = new AMGException(BaseException.SEVERITY_SUCCESS,
	...
	public void intializeFactory() throws AMGException {
	...
	@Override
	public List<PropData> requestList() throws AMGException {
		try {
	...
	@Override
	public URL getURL() throws AMGException {
	...
	@Override
	public synchronized void restart() throws AMGException {
		try {
			shutdown(true);
		} catch (AMGException e) {
			throw e;
	...
	@Override
	public synchronized void shutdown() throws AMGException {
		try {
			shutdown(false);
		} catch (AMGException e) {
			throw e;
	...
	public synchronized void shutdown(boolean restart) throws AMGException {
		try {
	...
	protected void cleanup(boolean restart) throws AMGException {
		try {
	...
	protected void loadConfig() {
		...
		try {
			ServerInfo.properties = ServerProperties.getInstance("org.amg.node.server.SimpleProperties");
