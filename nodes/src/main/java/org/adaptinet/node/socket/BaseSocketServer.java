	...
	static final public BaseSocketServer createInstance(String type,
		...
		try {
			if (type.startsWith("PROXY")) {
				c = (Class<BaseSocketServer>)Class.forName("org.adaptinet.node.socket.ProxySocketServer");
				baseType = type;
			} else if (type.startsWith("CALLBACK")) {
				c = (Class<BaseSocketServer>)Class.forName("org.adaptinet.node.socket.CallbackSocketServer");
				baseType = type;
				...
				c = (Class<BaseSocketServer>)Class.forName("org.adaptinet.node.socket.HttpSocketServer");
				baseType = type;
			}
