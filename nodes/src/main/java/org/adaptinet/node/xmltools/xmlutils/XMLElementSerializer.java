...
public class XMLElementSerializer extends AliasProcessor {
	...
	private int len = 0;
	private Map<String, List<Object>> lists = null;
	...
	@SuppressWarnings("unchecked")
	private final List<Object> getList(String name, Class<?> parentClass)
		...
		if (l == null) {
			l = (List<Object>)parentClass.newInstance();
			lists.put(name, l);
		}
		return l;
	}
