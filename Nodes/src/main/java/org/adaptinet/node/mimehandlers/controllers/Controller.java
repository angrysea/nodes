...
public abstract class Controller {
	...
	public final void View(Object viewData) throws IOException,
			ServletException {
		try {
	...
	public final void RedirectToAction(String view, String controller)
		...
		while (it.hasNext()) {
			...
			if (param != null && param.length > 0) {
				...
				try {
					...
					case DATE:
						try {
							executeMethod(o, name, new SimpleDateFormat(
									"yyyy-MM-dd'T'HH:mm:ss").parse(data));
	...
	protected Object executeMethod(Object targetObject, String name, Object data)
		...
		Object ret = null;
		Class[] paramdef = new Class[1];
		paramdef[0] = data.getClass();
		String methodName = "set" + name.substring(0, 1).toUpperCase()
				+ name.substring(1);
		Method m = targetObject.getClass().getMethod(methodName, paramdef);
